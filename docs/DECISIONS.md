...
הריץ את *אותה* התקדמות הרמונית (I–vi–IV–V) על כל חמשת הסגנונות, תמיד טריאדות נקיות למרות
...
(Ramer–Douglas–Peucker) עצמאי — כל נקודה ששורדת יושבת בפועל *על* המסלול המקורי, לא בנייה-
...
התבנית בפועל (עדיין pitch-של-בר-שלם, רק ריתמיקה שונה); `buildLeadTrack` שומר על *כמות* התווים
