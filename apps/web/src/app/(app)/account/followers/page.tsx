/**
 * @file        page.tsx
 * @description ⭐ 2026-08-22 (§11 גלריה, item 7): רשימת עוקבים — סימטרי ל-account/following,
 *              join הפוך (follower_id במקום following_id). בלי כפתור מעקב-הדדי (אין דרישה
 *              לזה) — רק קישור לפרופיל.
 * @author      Soundiform
 * @created     2026-08-22
 *
...
export default async function FollowersPage() {
  ...
  if (!user) {
    redirect('/login?next=/account/followers');
  }
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-2xl px-6 py-12">
        <h1 className="mb-8 text-3xl font-semibold tracking-tight">Followers</h1>
        {rows.length === 0 ? (
